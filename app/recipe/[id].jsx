...
const RecipeDetailScreen = () => {
  ...
  useEffect(() => {
    const checkIfSaved = async () => {
      try {
        ...
        console.error("Error checking if recipe id saved:", error);
      }
    };
    ...
    const loadRecipeDetail = async () => {
      ...
      try {
        ...
        if (mealData) {
          const transformMealRecipe = MealAPI.transformMealData(mealData);
  ...
  if (loading) return <LoadingSpinner message="Loading recipe details...r" />;
